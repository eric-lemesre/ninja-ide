...
class SchemesManagerWidget(QDialog):
    ...
    def __init__(self, parent):
        ...
        self.connect(btnReload, pyqtSignal("clicked()"), self._reload_themes)
        self._thread = ui_tools.ThreadExecution(self.execute_thread)
        self.connect(self._thread, pyqtSignal("finished()"), self.load_skins_data)
...
class SchemeWidget(QWidget):
    ...
    def __init__(self, parent, schemes):
        ...
        self.connect(btnUninstall, pyqtSignal("clicked()"), self._download_scheme)
