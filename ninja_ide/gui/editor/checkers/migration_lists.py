...
class MigrationWidget(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # connections
        self.connect(
            self.current_list, pyqtSignal("itemClicked(QListWidgetItem*)"),
            self.load_suggestion)
        self.connect(self.btn_apply, pyqtSignal("clicked()"), self.apply_changes)
        # registers
    ...
    def install_tab(self):
        ...
        self.connect(ide, pyqtSignal("goingDown()"), self.close)
